              ...
              <div className="space-y-2">
                {contactInfo.map((item, idx) => (
                  <a
                    key={idx}
                    href={item.href}
                    className="flex items-center space-x-3 p-3 bg-white/70 dark:bg-gray-900/70 backdrop-blur-sm rounded-lg border border-white/20 dark:border-gray-700/20 hover:shadow-lg transition-all duration-300"
                  >
                    <div className="text-blue-600 dark:text-blue-400">
                      {item.icon}
                    </div>
              ...
              <div className="flex space-x-3">
                {socialLinks.map((s, i) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`p-3 bg-white/70 dark:bg-gray-900/70 backdrop-blur-sm rounded-lg border border-white/20 dark:border-gray-700/20 text-gray-600 dark:text-gray-400 ${s.color} transition-all duration-300 hover:shadow-lg`}
                  >
                    {s.icon}
                  </a>
                ))}
          ...
          <div style={{ perspective: 1100 }} className="relative">
            ...
            >
                ...
                >
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
                      ...
                      <input
                        ...
                        className={`w-full px-3 py-2 text-sm bg-white dark:bg-gray-900 border ${
                          errors.name
                            ? "border-red-500"
                            : "border-gray-300 dark:border-gray-700"
                        } rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 text-gray-900 dark:text-white`}
                        placeholder="Your name"
                        disabled={isSubmitting}
                      />
                      {errors.name && (
                      ...
                      <textarea
                        ...
                        className={`w-full px-3 py-2 text-sm bg-white dark:bg-gray-900 border ${
                          errors.message
                            ? "border-red-500"
                            : "border-gray-300 dark:border-gray-700"
                        } rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 text-gray-900 dark:text-white resize-none`}
                        placeholder="Your message..."
                        disabled={isSubmitting}
                      />
                      {errors.message && (
                    ...
                    <motion.button
                      ...
                      type="submit"
                      disabled={isSubmitting}
                      className="w-full px-6 py-3 text-sm bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white rounded-lg font-medium transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center space-x-2"
                    >
                      {isSubmitting ? (
                        <>
              ...
              <div
                ...
                className="flex items-center justify-center rounded-lg p-6 bg-gradient-to-br from-green-900 to-green-800 text-center"
              >
                {submitStatus === "success" ? (
                  <div className="text-center">
                  ...
                  <div className="text-center">
                    <p className="text-xl font-bold text-yellow-200">Status</p>
